...
/// @nodoc
abstract class $PipStateCopyWith<T, $Res> {
  factory $PipStateCopyWith(
          PipState<T> value, $Res Function(PipState<T>) then) =
      _$PipStateCopyWithImpl<T, $Res, PipState<T>>;
}

/// @nodoc
class _$PipStateCopyWithImpl<T, $Res, $Val extends PipState<T>>
    implements $PipStateCopyWith<T, $Res> {
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$PipStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements PipState<T> {
