...
class FloatingOrderPart extends StatefulWidget {
  const FloatingOrderPart(
      {super.key,
      required this.onTap,
      required this.address,
      required this.buttonTitle, required this.headerTitle});
  ...
  @override
  State<FloatingOrderPart> createState() => _FloatingOrderPartState();
}

class _FloatingOrderPartState extends State<FloatingOrderPart> {
    ...
    return Row(
      ...
      children: [
        BlocBuilder<GlobalCubit, GlobalState>(
          buildWhen: (previous, current) => current is MyLoacationChange ,
          builder: (context, state) {
            return Flexible(
              child: Text(
                state.maybeWhen(
              
                    myLoacationChange: (address) {
                      return address;
                    },
                    orElse: () => ''),
