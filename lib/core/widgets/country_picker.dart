...
class CodePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return CodePickerState(elements);
  }
}

class CodePickerState extends State<CodePicker> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  CodePickerState(this.elements);
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null) {
      internalWidget = InkWell(
        onTap: showCodePickerDialog,
        child: widget.builder!(selectedItem),
      );
    } else {
      internalWidget = TextButton(
        onPressed: widget.enabled ? showCodePickerDialog : null,
        child: Padding(
  ...
  @override
  void didUpdateWidget(CodePicker oldWidget) {
  ...
  void showCodePickerDialog() async {
