...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_libphonenumber_ios/flutter_libphonenumber_ios.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/wifi_info_flutter/wifi_info_flutter.framework"
